...
declare const owner1: OwnerClass;
declare const car1: VehicleClass;
...
declare class CarModel implements Car {
    brand: string;
    model: string;
    year: number;
    vin: string;
...
declare class MotorbikeModel implements Motorbike {
    brand: string;
    model: string;
    year: number;
    vin: string;
...
declare const car2: CarModel;
declare const motorbike1: MotorbikeModel;
interface VehicleStorage<T extends Vehicle> {
    creationDate: Date;
    vehicles: T[];
    getAllVehicles(): T[];
}
declare class VehicleStorageClass<T extends Vehicle> implements VehicleStorage<T> {
    creationDate: Date;
    vehicles: T[];
    constructor();
    getAllVehicles(): T[];
...
declare const vehicleStorage: VehicleStorageClass<Vehicle>;
